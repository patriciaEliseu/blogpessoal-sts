...
public class PostagemController {
	...
	public ResponseEntity<Postagem> postPostagem(@Valid @RequestBody Postagem postagem) {
		//para deixar o id nulo para o front-end não gerar id para não dar conflito com o auto increment do banco
		postagem.setId(null);
	...
	public void deletePostagem(@PathVariable Long id) {
        ...
        if(postagem.isEmpty())
        	//Quando lançamos uma exceção não precisamos usar o else, pois a exceção interrompe o fluxo normal do programa
